  ...
  render() {
    return (
      <div className="SearchableMap">
        ...
        <h1>{this.state.venues[0].name}</h1>
        <div className="small-park-pic"><img src={this.state.dogPic} alt={this.state.venues[0].name+" photo"}/></div>
        <h3>{this.state.venues[0].location.address}</h3>
